...
export default function Header() {
    ...
    return (
        <div className="z-50 px-8 py-4 border-b h-16 border-slate-200 flex items-center bg-white/50 backdrop-blur-3xl sticky top-0">
          ...
          <div className="ml-auto md:hidden relative">
            ...
            {isMenuOpen && (
              <div className="z-50 absolute top-0 right-0 menu bg-white shadow-2xl p-4 w-64 min-h-screen">
                ...
                <Input placeholder="Search docs..." className="mt-4 mb-8 shadow-sm w-full" size="sm" />
